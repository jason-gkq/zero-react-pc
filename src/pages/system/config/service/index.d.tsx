...
export type IResQueryConfigList = Models['GET/system/config/list']['Res']['rows'][0]
...
export type IReqExportConfig = Models['GET/system/config/export']['Req']
export type IResExportConfig = Models['GET/system/config/export']['Res']

export type IResGetConfigKey = Models['GET/system/config/configKey']['Res']
